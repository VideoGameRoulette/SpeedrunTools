...
const RE2RItems = () => {
    ...
    const { Items, InventoryCount, MainSlot, SubSlot, Shortcuts, SubShortcuts } = data;
    ...
    return (
        <>
            ...
            <div className="absolute w-full h-full flex flex-col p-4 gap-2">
                <RE2RInventory items={sortedItems} inventoryCount={InventoryCount} mainSlot={MainSlot} subSlot={SubSlot} shortcuts={Shortcuts} subShortcuts={SubShortcuts} />
            </div>
        </>
    );
}
